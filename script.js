...
function initializeIndexPage() {
    ...
    async function trackShipment() {
        ...
        if (!trackingNumber.match(/^\d{10}$/)) {
            showError("Invalid tracking number format. Please enter a 10-digit tracking number.");
            return;
        }
...
function setupAdminPage() {
    ...
    window.downloadQRCode = function() {
        ...
        try {
            ...
            link.download = `Skylink_Express_QR_${window.currentQRData.trackingNumber}.png`;
