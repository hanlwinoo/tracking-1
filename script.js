...
const i18n = {
    en: {
        ...
        trackingHelp: "Format: SF followed by 13 digits",
...
function initializeIndexPage() {
    ...
    function checkUrlParams() {
        ...
        // If arriving via QR code scan (URL contains tracking parameters)
        if (trackingParam && codeParam) {
            // Force language mode to English always when QR code is scanned
            currentLang = 'en';
            ...
            // Update template text elements to English
            updatePageLanguage('en');

            // Hide Language Selector and Admin Login Button
            const headerControls = document.getElementById('headerControls');
            if (headerControls) headerControls.style.display = 'none';
            if (adminLoginBtn) adminLoginBtn.style.display = 'none';

            // Auto-fill inputs and track shipment
