...
const trackingSteps = [
    { step: 1, en: "Order Created & Registered", zh: "订单已创建并注册" },
    { step: 2, en: "Awaiting scheduled courier pickup", zh: "等待快递员按计划揽收" },
    { step: 3, en: "Picked Up by Courier", zh: "快递员已揽收" },
    { step: 4, en: "Arrived at Regional Logistics Center", zh: "到达区域物流中心" },
    { step: 5, en: "Departed Origin Hub", zh: "已离开始发地转运中心" },
    { step: 6, en: "Arrived at transit cargo hub of Doha, Qatar", zh: "到达卡塔尔多哈中转货运枢纽" },
    { step: 7, en: "Cargo transfer", zh: "货物中转/转运" },
    { step: 8, en: "Arrived at international transit of Frankfurt, Germany", zh: "到达德国法兰克福国际中转站" },
    { step: 9, en: "Awaiting connecting flight", zh: "等待转接航班" },
    { step: 10, en: "Arrived at U.S entry airport", zh: "到达美国入境机场" },
    { step: 11, en: "Arrived at Customs Facility", zh: "到达海关监管中心" },
    { step: 12, en: "Customs Clearance in Progress", zh: "海关清关中" },
    { step: 13, en: "Customs cleared Successfully", zh: "海关清关成功" },
    { step: 14, en: "Arrived at Destination Distribution Hub", zh: "到达目的地分拨中心" },
    { step: 15, en: "Out for Local Delivery", zh: "派送员正在派送中" },
    { step: 16, en: "Delivery Attempt in Progress", zh: "正在尝试送达" },
    { step: 17, en: "Package Delivered Successfully", zh: "包裹已成功签收" }
];

const i18n = {
    en: {
        adminTitle: "Skylink Express Admin",
        ...
        manageSubtitle: "Manage tracking histories and export QR codes or direct links",
        ...
        qrModalTitle: "Shipment QR Pass & Link",
        qrTracking: "Tracking Number:",
        qrCode: "Confirmation Code:",
        qrReceiver: "Receiver:",
        qrInstruction: "Scan or click below to directly access real-time tracking.",
        btnSaveQR: "Save QR Image",
        btnCopyLink: "Copy Direct Tracking Link",
        btnClose: "Close",
        alertSameCountry: "Origin and destination cannot be the same.",
        alertSuccess: "Shipment created successfully!",
        alertGenQR: "Generate QR code / Link now?",
        
        // Tracking Page i18n
        tagline: "Reliable Global Logistics Solutions",
        trackYourShipment: "Track Your Shipment",
        trackingNumber: "Tracking Number",
        trackingHelp: "10-digit numeric tracking number",
        confirmationCode: "Confirmation Code",
        confirmationHelp: "4 random letters/numbers provided when shipment was created",
        trackButton: "Track Shipment",
        adminPortal: "Admin Portal",
        shipmentStatus: "Status:",
        lblTrackingNo: "Tracking Number:",
        lblConfirmCode: "Confirmation Code",
        lblOrigin: "Origin",
        lblDestination: "Destination",
        lblSender: "Sender",
        lblSenderPhone: "Sender WhatsApp",
        lblSenderAddress: "Sender Address",
        lblReceiver: "Receiver",
        lblAddress: "Delivery Address",
        lblPhone: "Receiver Phone",
        historyProgress: "Tracking History Progress",
        searchAnother: "Search Another Shipment",
        footerText: "For shipment booking, please contact our customer service.",
        adminAuth: "Admin Authentication",
        enterPass: "Enter Administrator Password",
        loginPortal: "Login to Portal",
        errFillFields: "Please enter both tracking number and confirmation code.",
        errNotFound: "Shipment not found.",
        errInvalidCode: "Invalid confirmation code.",
        errFetch: "Error fetching shipment."
    },
    zh: {
        adminTitle: "Skylink Express 管理后台",
        ...
        manageSubtitle: "管理运单历史状态并导出二维码或直达链接",
        modalUpdateTitle: "更新物流状态",
        lblSelectStep: "选择物流节点",
        lblCurrentLocation: "选择当前枢纽位置",
        btnSaveUpdate: "保存物流节点",
        qrModalTitle: "运单二维码与直达链接",
        qrTracking: "运单号：",
        qrCode: "确认码：",
        qrReceiver: "收件人：",
        qrInstruction: "扫码或点击下方按钮，即可直接跳转至实时追踪页面。",
        btnSaveQR: "保存二维码图片",
        btnCopyLink: "复制直达追踪链接",
        btnClose: "关闭",
        alertSameCountry: "始发地和目的地不能相同。",
        alertSuccess: "运单创建成功！",
        alertGenQR: "是否立即生成二维码 / 直达链接？",
        
        // Tracking Page i18n
        tagline: "值得信赖的全球物流解决方案",
        trackYourShipment: "追踪您的包裹",
        trackingNumber: "运单号",
        trackingHelp: "10 位纯数字运单号",
        confirmationCode: "确认码",
        confirmationHelp: "创建运单时提供的 4 位随机字母/数字",
        trackButton: "查询运单",
        adminPortal: "管理员入口",
        shipmentStatus: "物流状态：",
        lblTrackingNo: "运单号：",
        ...
        lblDestination: "目的地",
        lblSender: "寄件人",
        lblSenderPhone: "寄件人 WhatsApp",
        lblSenderAddress: "寄件人地址",
        lblReceiver: "收件人",
        lblAddress: "派送地址",
        lblPhone: "收件人电话",
        historyProgress: "物流追踪历史",
        searchAnother: "查询其他运单",
        footerText: "如需寄件服务，请联系我们的客服团队。",
        adminAuth: "管理员身份验证",
        enterPass: "请输入管理员密码",
        loginPortal: "登录管理后台",
        errFillFields: "请输入运单号和确认码。",
        errNotFound: "未找到相关运单信息。",
        errInvalidCode: "确认码错误。",
        errFetch: "获取运单信息失败。"
    }
};
...
function getLocalizedLocationText(locationVal, lang) {
    if (!locationVal) return "";
    const matchedLoc = predefinedLocations.find(l => l.zh === locationVal || l.en === locationVal);
    if (matchedLoc) {
        return lang === 'zh' ? matchedLoc.zh : matchedLoc.en;
    }
    return lang === 'zh' ? (countryTranslations[locationVal] || locationVal) : locationVal;
}
...
function initializeIndexPage() {
    ...
    if (langSelect) {
        ...
        langSelect.addEventListener('change', (e) => {
            ...
            if (currentShipmentData) {
                displayShipmentInfo(currentShipmentData, currentTrackingNumber);
            }
        });
    }
    ...
    function checkUrlParams() {
        ...
        if (trackingParam && codeParam) {
            currentLang = 'en';
            localStorage.setItem('sfAdminLang', 'en');
    ...
    async function trackShipment() {
        ...
        if (!trackingNumber || !confirmationCode) {
            errorMessage.textContent = langDict.errFillFields;
        ...
        try {
            ...
            if (!snapshot.exists()) {
                errorMessage.textContent = langDict.errNotFound;
                errorMessage.style.display = 'block';
            ...
            if (shipment.confirmationCode.toUpperCase() !== confirmationCode) {
                errorMessage.textContent = langDict.errInvalidCode;
                errorMessage.style.display = 'block';
                trackButton.disabled = false;
                return;
            }
            ...
            errorMessage.textContent = langDict.errFetch;
            errorMessage.style.display = 'block';
            trackButton.disabled = false;
        }
    }
    ...
    function displayShipmentInfo(shipment, trackingNumber) {
        ...
        if (shipment.currentStep) {
            displayStatus = getLocalizedStepText(shipment.currentStep, currentLang);
        }

        const originVal = currentLang === 'zh' ? (countryTranslations[shipment.origin] || shipment.origin) : shipment.origin;
        const destVal = currentLang === 'zh' ? (countryTranslations[shipment.destination] || shipment.destination) : shipment.destination;
        ...
        document.getElementById('displayOrigin').textContent = originVal || 'N/A';
        document.getElementById('displayDestination').textContent = destVal || 'N/A';
        ...
        document.getElementById('displaySenderPhone').textContent = shipment.sender?.phone || 'N/A';
        document.getElementById('displaySenderAddress').textContent = shipment.sender?.address || 'N/A';

        // Receiver details display
        ...
        history.forEach((event) => {
            const descriptionText = event.step ? getLocalizedStepText(event.step, currentLang) : (event.description || '');
            const localizedLocation = getLocalizedLocationText(event.location, currentLang);
            ...
            timelineItem.innerHTML = `
                ...
                <div class="timeline-location">${localizedLocation}</div>
            `;
...
function initializeAdminPage() {
    ...
    function buildTrackingUrl(trackingNumber, confirmationCode) {
        ...
        return `${targetHost}${directoryPath}index.html?tracking=${encodeURIComponent(trackingNumber)}&code=${encodeURIComponent(confirmationCode)}`;
    }
                ...
                tr.innerHTML = `
                    ...
                    <td class="col-actions">
                        <div class="table-actions-row">
                            <button class="btn btn-primary btn-sm" title="Edit Progress" onclick="showUpdateModal('${shipment.trackingNumber}')"><i class="fas fa-edit"></i></button>
                            <button class="btn btn-secondary btn-sm" title="Show QR Code" onclick="generateQRCode('${shipment.trackingNumber}', '${shipment.confirmationCode}', '${shipment.receiver?.name || ''}')"><i class="fas fa-qrcode"></i></button>
                            <button class="btn btn-secondary btn-sm" title="Generate Direct Link" onclick="generateDirectLink('${shipment.trackingNumber}', '${shipment.confirmationCode}')"><i class="fas fa-link"></i></button>
                            <button class="btn btn-danger btn-sm" title="Delete Shipment" onclick="deleteShipment('${shipment.trackingNumber}')"><i class="fas fa-trash"></i></button>
                        </div>
                    </td>
                `;
    ...
    window.generateQRCode = function(trackingNumber, confirmationCode, receiverName) {
        ...
        const trackingUrl = buildTrackingUrl(trackingNumber, confirmationCode);
    ...
    window.generateDirectLink = function(trackingNumber, confirmationCode) {
        const trackingUrl = buildTrackingUrl(trackingNumber, confirmationCode);
        
        navigator.clipboard.writeText(trackingUrl).then(() => {
            alert(`Direct tracking link copied to clipboard!\n\nLink: ${trackingUrl}`);
        }).catch(() => {
            prompt("Copy this tracking URL:", trackingUrl);
        });
    };

    window.copyTrackingLink = function() {
        if (window.currentQRData && window.currentQRData.url) {
            navigator.clipboard.writeText(window.currentQRData.url).then(() => {
                alert(`Tracking link copied to clipboard!\n\n${window.currentQRData.url}`);
            }).catch(() => {
                prompt("Copy this tracking URL:", window.currentQRData.url);
            });
        }
    };
